...
@Configuration
@EnableJpaRepositories("com.twimba.stocksmate.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.twimba.stocksmate.repository.search")
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.twimba.stocksmate.config.HerokuDatabaseConfiguration")
